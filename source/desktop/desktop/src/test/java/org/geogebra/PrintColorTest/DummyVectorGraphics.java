...
class DummyVectorGraphics extends AbstractVectorGraphics {

	/* ===== 只实现抽象方法的空体或简单返回 ===== */
	@Override protected Shape createShape(double[] x, double[] y, int n, boolean c) { return null; }
	...
	@Override public Stroke getStroke() { return new BasicStroke(); }
	...
	@Override public AffineTransform getTransform() { return new AffineTransform(); }
	...
	@Override public Paint getPaint() { return Color.BLACK; }
	...
	@Override public void setPaint(Paint paint) { super.setPaint(paint); }
	...
	@Override public void clearRect(double x, double y, double w, double h) {}
	...
	//@Override public void drawImage(Image image, double x, double y, double width, double height, ImageObserver observer) {}
	//@Override public Rectangle2D getClipBounds() { return new Rectangle2D.Double(); }
	...
	public Color getPrintColorPublic(Color c) {
		return super.getPrintColor(c);
	}
}
